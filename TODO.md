...
- [ ] Create a stable fake tutorial fixture for E2E coverage (regions, text-only steps, no-region file steps, images/carousel, vars/secrets, downloads, preview states); avoid using the real OAuth tutorial as the main framework-behavior fixture.
